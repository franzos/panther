  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "17nhd675bbik5zb49ikmgsv5jv69sfm8k71yjk4q61vxb50b5kg7"))))
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             "/v2ray-linux-64.zip"))
       (sha256
        (base32 "0xvig5pdh20a6zkd2038rcv94a756mcv5s9bvkp3h4dsyg027ccq"))))
    (build-system binary-build-system)
    (arguments
    ...
    (package
      ...
      (source (origin
                ...
                (uri (go-git-reference
                      ...
                      (commit "v1.102.2")
                      (sha (base32 "1227ck9gdds0kaf0dpcjzq8cz1bfjnj72hk2y7z39qhiy63558xy"))))
                (sha256
                 (base32
                  "1vy1vi70ph18kqfsyvhgkzif69j6hy2672qh69qbc5ql7rvzcnmz"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "13yhppz3b76ra60wimivf8c5w1jbcm11rmsjwqbxsjmrjwj6hlj5"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (string-append name "-" version ".tar.gz"))
       (sha256
        (base32 "0aaar94hpi7vbzkf9d60hzzpgnc5p4q1by3rks7xm7ajn1ik2khn"))))
    (build-system cargo-build-system)
    (arguments
     `(#:install-source? #f
       #:tests? #f
