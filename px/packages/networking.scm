    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             "/v2ray-linux-64.zip"))
       (sha256
        (base32 "1sw5qbx0gn88irwa4y5fax9vyvrikyc2azl94f4s6vmv606xxlyp"))))
    (build-system binary-build-system)
    (arguments
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1kywgxgg8g8bjy080fwiax1sn2wyj0w1vimv56i0n5vvdn25gjy6"))))
    (build-system binary-build-system)
    (arguments
    ...
    (package
      ...
      (source (origin
                ...
                (uri (go-git-reference
                      ...
                      (commit "v1.94.1")
                      (sha (base32 "0n5k8adplcffjwlpiy35nrklc0sf9ms18zlilcis5g1s3kdh4klf"))))
                (sha256
                 (base32
                  "1mdrq6yj3jnn6gp03lv1k7zapzp5iqshp8cxvlxrxd16dh8806j6"))))
