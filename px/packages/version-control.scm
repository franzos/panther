  ...
  (package
    ...
    (source (origin
              ...
              (uri (go-git-reference
                    ...
                    (sha (base32
                          "11bz1mibksixbbq31gasdqmfx7gjclaw19q119xa7nsv5ndb03j0"))))
              (sha256
               (base32
                "0zr6x81ljl23h0jyvmvjzdjg4dajgvwahbbal6pyf906qldbf4lz"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0vq7zysy57slnnb3gqnw9wxfyziw684zbswqbcmn67vkrq260cp7"))))
