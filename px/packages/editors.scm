...
(define-public vscode
  (package
    ...
    (inputs `(("vscode" ,(make-vscode-release-asset version "vscode"
                          "1sc92pa3zdfidlm0vl2xxvqnnai68q7p4ab7ds0hdd6d1gr64gj9"))
              ("gcc:lib" ,gcc "lib")
              ("gcc" ,gcc "lib")
              ("glib" ,glib)
              ("nss" ,nss)
...
(define-public cursor
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri "https://downloads.cursor.com/production/7b9c34466f5c119e93c3e654bb80fe9306b6cc79/linux/x64/deb/amd64/deb/cursor_2.4.37_amd64.deb")
       (sha256 (base32 "0k06d2qvlph0l3bn98zhnn5pfiyijma6wg1jyw30jdaw5d0hd55l"))))
    (build-system binary-build-system)
    (arguments
  ...
  (package
    ...
    (inputs `(("zed"
               ,(origin
                  ...
                  (sha256
                   (base32 "0cb05icym8qdp6invgckh2bxly2h892k3f5a9lpzrnx1mi81d1sf"))))
              ("bash-minimal" ,bash-minimal)
              ("glib" ,glib)
              ("gtk+" ,gtk+)
              ("libx11" ,libx11)
