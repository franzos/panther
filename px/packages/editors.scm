...
(define-public vscode
  (package
    ...
    (inputs `(("vscode" ,(make-vscode-release-asset version "vscode"
                          "064j80ck9lbaasngr7j71lq3k9j1cl6d0dx1xl9s9slvskq58jlv"))
              ("gcc:lib" ,gcc "lib")
              ("gcc" ,gcc "lib")
              ("glib" ,glib)
              ("nss" ,nss)
...
(define-public cursor
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri "https://downloads.cursor.com/production/b29eb4ee5f9f6d1cb2afbc09070198d3ea6ad76f/linux/x64/deb/amd64/deb/cursor_2.6.20_amd64.deb")
       (sha256 (base32 "07q4a4xmykdm7b1850vqbi386n557j75p364jzv5x1yb8vqamsaj"))))
    (build-system binary-build-system)
    (arguments
               ...
               ,(origin
                  ...
                  (sha256
                   (base32
                    (match (or (%current-system) (%current-target-system))
                      ("x86_64-linux"
                       "1b8bgjwfb2n2rfz0l2qbbv54q41c0xpafvzhgmcd6pzcv1l259pf")
                      ("aarch64-linux"
                       "19w1l10sq6ppzczzwhy9472mznpb1ahcz32p03bz1i2r236kpsby"))))))
              ("bash-minimal" ,bash-minimal)
              ("glib" ,glib)
              ("gtk+" ,gtk+)
              ("libx11" ,libx11)
