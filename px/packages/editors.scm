...
(define-public vscode
  (package
    ...
    (inputs `(("vscode" ,(make-vscode-release-asset version "vscode"
                          "02mwa0yagmqm46fvjk26152d4zvaijk81jcykgbsaz1fz76i9kfy"))
              ("gcc:lib" ,gcc "lib")
              ("gcc" ,gcc "lib")
              ("glib" ,glib)
              ("nss" ,nss)
...
(define-public cursor
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri "https://downloads.cursor.com/production/224838f96445be37e3db643a163a817c15b3606c/linux/x64/deb/amd64/deb/cursor_2.6.19_amd64.deb")
       (sha256 (base32 "0qd35i32n05w8wkqmzvmc578xrp7dgi0ajj1n19pkdyncgzgy61v"))))
    (build-system binary-build-system)
    (arguments
  ...
  (package
    ...
    (inputs `(("zed"
               ,(origin
                  ...
                  (sha256
                   (base32 "0905n4wnw1lmwhk043czgvacc5d5m4z9i45v36cwcs4k8q8vlx10"))))
              ("bash-minimal" ,bash-minimal)
              ("glib" ,glib)
              ("gtk+" ,gtk+)
              ("libx11" ,libx11)
