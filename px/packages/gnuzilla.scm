...
(define %thunderbird-version "156.0")
(define %thunderbird-build-id "20260915000000") ;must be YYYYMMDDhhmmss
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "13ljqp55h7ak0swgx420xafnryc5q4i1dwp6p21v9a8r1qb8a0fj"))))
    (properties
