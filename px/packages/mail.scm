...
(define bichon-source
  (origin
    ...
    (sha256
     (base32 "1wcmlfw42va6w2b68p7kpbcp223vbw3c2s7kn4dc1jh0apy4jsr1"))
    (snippet
        #~(begin
...
(define bichon-web-dist
  (computed-file
   ...
   #:options `(#:hash-algo sha256
               #:hash ,(base32 "19wgg2f0rx7nrd8xkriaany468vqkzjgq0r58cg63b2gndgdq6sm")
               #:recursive? #t)))
