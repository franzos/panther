    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             version ".tar.gz"))
       (sha256
        (base32 "103qdx4l6j9wj971vrij5bzkybnmr7y4jc16yz0pxds838pc66bs"))))
    (build-system cmake-build-system)
    (arguments
     `(#:tests? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0xprzyzmaijf924qd707ps9c4bfamj12h8sgfwv0mw21w1iv7vli"))))
    (supported-systems '("x86_64-linux"))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "02h770x73wdad32nx98fplcbdp4q3yymfcwhi60702mirssipxhj"))))
    (supported-systems '("x86_64-linux"))
    (build-system binary-build-system)
    (arguments
     `(#:validate-runpath? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "18502d3667dr5q5xfhcf92zyyxpc9c1173v54j8l8s5548k0x3cy"))))
    (supported-systems '("x86_64-linux"))
    (build-system binary-build-system)
    (arguments
     (list
