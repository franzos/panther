    ...
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (recursive? #t)))
       (sha256
        (base32 "17wpl77li7dl94fmz4spxjrmsls5m4fjhs8hcv5bkvi6j5jmx0nx"))
    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             version ".tar.gz"))
       (sha256
        (base32 "1fspj6d2r3szvqm6ny4n5r970cga37qaidq3mjpqhrcslldigqpr"))))
    (build-system cmake-build-system)
    (arguments
     `(#:tests? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0bqvsynv66mjxc6b8ngn644mi5lmggcdsp9rbb3x3z2sdw13crcn"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0mwapy6kq6d035vrbzxhi73r30w2wjp295r8g30zkgh56ackayay"))))
    (supported-systems '("x86_64-linux"))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0jnyhdxhgiri4dfawxavnq74ip2h2ng6flapzzxwv0kg44pm4mmv"))))
      (build-system cargo-build-system)
      (arguments
       `(#:install-source? #f))
      (inputs
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "19l52z605jqvkvdixhq6s8qhwqrag8nk9q5jjf0yx5960i76c6zs"))))
    (supported-systems '("x86_64-linux"))
    (build-system binary-build-system)
    (arguments
     (list
