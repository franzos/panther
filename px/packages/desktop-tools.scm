  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0jig1f2cil7vpmvm98qzh1j1nii6ybj6drb48479hl8khllr7513"))))
    (supported-systems '("x86_64-linux"))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0zjlbxyy13m5n137vswx2pshrhs31y9fwlznmcxvwhg11jjz09n4"))))
    (supported-systems '("x86_64-linux"))
    (build-system binary-build-system)
    (arguments
     `(#:validate-runpath? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0j3jaaiyfr00vqq0kri1yi6f2gafasg8b1r4ql40r7g46yn1f857"))))
    (supported-systems '("x86_64-linux"))
    (build-system binary-build-system)
    (arguments
     (list
