    ...
    (source
     (origin
       ...
       (uri (git-reference
             ...
             (recursive? #t)))
       (sha256
        (base32 "0bfqb972w22xy4z151bmy0fn8ania1cj7zys2byvgp7s2vg5808g"))
     ...
     (origin
       ...
       (uri
        (string-append
         ...
         "/discord-" version ".deb"))
       (sha256
        (base32 "1fj8v75l3qzwbqls65mg3g1a4lcscn04nha8fzvwp6bc5z4bzvg4"))))
    (supported-systems '("x86_64-linux"))
    (build-system chromium-binary-build-system)
    (arguments
     (list #:validate-runpath? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1xwvc5jwa9iv1ql54jgfx37r64sgvygapzrgzjcqdcl7jils5gjr"))))
    (supported-systems '("x86_64-linux"))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "15djbn6hhrz9ya447y3pl3nbvimkbhp10z7jln35q2zwjxfmb2z6"))))
    (build-system cargo-build-system)
    (arguments
     `(#:install-source? #f
       #:tests? #f
