    ...
    (source
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux" "0gak2hfw0l1sy3x9la6zz68m7nah5k72nn9cqviqdzrsm0wnbx5g")
           ("aarch64-linux" "0wlvyx23yh2s300lzmh6d1s592nv46bvyh3jqig37jyslsm153jm"))))))
     ...
     (origin
       ...
       (uri (string-append
             ...
             (match (or (%current-system) (%current-target-system))
               ...
               ("armhf-linux" "arm")) ".zip"))
       (sha256
        (base32 "0hmqsgmbzmdvs37w7g13lp35szk2drfh01nrv2xfz8ffkvbbv8a0"))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
     ...
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux"
            "0bg5kg4yas3r41fgik5qb0ral8jxcrn46lq3qpp6lwjxh2k997g4")
           ("aarch64-linux"
            "0zfdin1816wlamh7d4w41509v1dy7b7fx3d998arfi6lsbha5c64"))))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0dkaqx5zgqvfa63vvsky6qs9mga6b90zfmzhcw5l1x86yf71k5vv"))))
  ...
  (package
    ...
    (source (origin
              ...
              (uri (go-git-reference
                    ...
                    (commit (string-append "v" version))
                    (sha (base32 "1pxm05xxpxl04iznbpprxnl4vfrvf2ng2dzdipp8zp9qnnsa840y"))
                    (go go-1.27)))
              (sha256
               (base32
                "110cv6p8867sl3vgww7w173nfpihi7d58w7p3hm6f3hqs7d4bl39"))))
    (build-system go-build-system)
    (arguments
     (list
      #:import-path "github.com/d2lang/d2"
      #:install-source? #f
      #:go go-1.27
      #:phases
      #~(modify-phases %standard-phases
