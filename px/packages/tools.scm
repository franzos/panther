    ...
    (source
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux" "1kr12fcgbqdn9mirfcyzdgdbvzc80arpi88z8gahll3lvg4xdnns")
           ("aarch64-linux" "1kpalfdw0mnzc190wll71p4l396na9gw44iwrjrm862laj00pflx"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "16x9mvlxfbw07i4bsj1nsisdkihzxdlhhqyd701ywrar6cpl4jgc"))))
    (build-system cargo-build-system)
    (arguments
     `(#:install-source? #f
       #:tests? #t))
     ...
     (origin
       ...
       (uri (string-append
             ...
             (match (or (%current-system) (%current-target-system))
               ...
               ("armhf-linux" "arm")) ".zip"))
       (sha256
        (base32 "0jrggjc62lywvsb1x8y659w4iypb8qxdgvalr2fq0agldvajjvnq"))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
