    ...
    (source
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux" "17zcn6bzqfpp8k1kgkzdbilqqy43wx2lqw8pcwpj74zlxlxs3gmn")
           ("aarch64-linux" "0k88aa4m0mhk1l96ad795zlxj7j7jkc1ilncijvv63bfssf7hcsl"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1m9dzk6r1hy3aks2vx3lx5k94b0w0ry1bbafs7whspybdh57glvj"))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "11mp3i7w8m9i0xyh31pm44xk42ml4kxrchhj8csvnax933r7dm98"))))
    (build-system cargo-build-system)
    (arguments
     `(#:install-source? #f
       #:tests? #t))
     ...
     (origin
       ...
       (uri (string-append
             ...
             (match (or (%current-system) (%current-target-system))
               ...
               ("armhf-linux" "arm")) ".zip"))
       (sha256
        (base32 "1a49iddz2qpziq2gw7klr1c4iymzli7mvgjkm3jgr4i4z21ip2wp"))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
     ...
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux"
            "17zry445ip3ix1xhlfgdkg45c4bj94vl5mzrnfbrviyqimxnmj2i")
           ("aarch64-linux"
            "1cz8fdmmxg19m30dzc29916pv3xvbcqba09x9010zjlia7vdz68p"))))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
