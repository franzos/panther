    ...
    (source
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux" "0djcaj89csnxjyxwgy08ws8labnip9pfsjajzgq0fkl3fgky4ih2")
           ("aarch64-linux" "144bndc8zacczpwvc2wn3llb256nx1k3n20x9f5spcb6ys07qrzb"))))))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1rrlgg3k1zq7pjxk7bm5ny21j6kksvzzd8qg2fdkrndrg3x1cfcr"))))
     ...
     (origin
       ...
       (uri (string-append
             ...
             (match (or (%current-system) (%current-target-system))
               ...
               ("armhf-linux" "arm")) ".zip"))
       (sha256
        (base32 "1mjdgxyjcklhbppiwnchxfxrdawgh4n5y7jxyawsgrbyw6izz848"))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
     ...
     (origin
       ...
       (sha256
        (base32
         (match (or (%current-system) (%current-target-system))
           ("x86_64-linux"
            "0cp347i2rfhd0cy0dkl5nr5xkzvgxyq6an8ysvhgivdmys1nw2xf")
           ("aarch64-linux"
            "0bxhl63v5k08nf420zc0r9n2nbn193y6ns1yd0hza7i5jbvsrr6g"))))))
    (build-system binary-build-system)
    (arguments
     (list
      #:install-plan
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1pn4f49k1ys48vw8qzn6lrh0wm974bqwzfxi89hwydys3kjzp9x9"))))
