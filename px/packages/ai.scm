  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1kndm3q2dhrkyzkyzgn130pcpg8xh5j1zs2y5ksrsa95bff40fyz"))))
...
(define-public claude-desktop
  (package
    (name "claude-desktop")
    (version "1.11847.5-2.0.19")
    (source
     (origin
       (method url-fetch)
       (uri (string-append
             "https://github.com/aaddrick/claude-desktop-debian/releases/"
             "download/v2.0.19+claude1.11847.5/"
             "claude-desktop_1.11847.5-2.0.19_amd64.deb"))
       (file-name (string-append name "-" version ".deb"))
       (sha256
        (base32 "1rdig8qayzjznjafqjypqyqqdgv9h9kmiw5gij5aplf8xhb4ma7l"))))
    (build-system binary-build-system)
    (arguments
     (list
      #:strip-binaries? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "186wv27lpck34viahr30a6nrwbdvw3157hqy106b7xgmyb1b5qpz"))))
    (build-system binary-build-system)
    (arguments
     (list
      #:strip-binaries? #f
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "098f3gr0l6h1ghy719j1yjrc9khbvq4i4aai03a96zkqckjqy3wb"))))
